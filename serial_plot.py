...
parser.add_argument('-p','--port_name', default='COM4', help='The name of the serial port, default=COM3')
parser.add_argument('-b','--baud_rate', default=57_600, help ='Baud rate, default=9600', type=int)
